 ...
 * no description
 */
var CaptchaApiRequestFactory = /** @class */ (function (_super) {
    __extends(CaptchaApiRequestFactory, _super);
    function CaptchaApiRequestFactory() {
     ...
     */
    CaptchaApiRequestFactory.prototype.apiAdminCaptchaCheckPost = function (captchaId, slideTrack, _options) {
        var _a, _b, _c;
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        localVarPath = '/api/admin/Captcha/check';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        // Query Params
                        if (captchaId !== undefined) {
                            requestContext.setQueryParam("captchaId", ObjectSerializer_1.ObjectSerializer.serialize(captchaId, "string", ""));
                        }
                        ...
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(slideTrack, "SlideTrack", ""), contentType);
     ...
     * @param captchaId 验证码id
     */
    CaptchaApiRequestFactory.prototype.apiAdminCaptchaGeneratePost = function (captchaId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        localVarPath = '/api/admin/Captcha/generate';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        // Query Params
                        if (captchaId !== undefined) {
    ...
    return CaptchaApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.CaptchaApiRequestFactory = CaptchaApiRequestFactory;
var CaptchaApiResponseProcessor = /** @class */ (function () {
    function CaptchaApiResponseProcessor() {
    }
    /**
     ...
     */
    CaptchaApiResponseProcessor.prototype.apiAdminCaptchaCheckPost = function (response) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    CaptchaApiResponseProcessor.prototype.apiAdminCaptchaGeneratePost = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, _j, _k;
            return __generator(this, function (_l) {
                switch (_l.label) {
    ...
    return CaptchaApiResponseProcessor;
}());
